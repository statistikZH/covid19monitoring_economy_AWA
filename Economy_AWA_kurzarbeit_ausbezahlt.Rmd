...
datalist[[counter]] <- krzarb_bezahlt2[krzarb_bezahlt2$noga!='Rest',]
...
ggsave('plots/Economy_AWA_ausbezahlt_branchen_tweet.png',width = 22.86, height =14.128, units = c("cm"),dpi=300,scale=3)
```
